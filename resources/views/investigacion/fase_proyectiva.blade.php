...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Determinemos eventos, sinergias e indicios <small>Fase Proyectiva</small></h2>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" placeholder="Descripción" id="evento-descripcion" required="required" class="form-control col-md-7 col-xs-12">
              </div>
              <div class="col-md-3 col-sm-3 col-xs-12">
              ...
              <div class="col-md-1 col-sm-1 col-xs-12">
                <button type="button" id="agregar-evento" class="btn btn-round btn-md btn-info">+</button>
              </div>
            </div>
          </div>
        </div>
                        ...
                        <div class="panel-body">
                          ...
                          <div class="row">
                            <div class="col-md-11 col-sm-11 col-xs-12">
                              ...
                              <input type="text" placeholder="Agruegue los indicios de este evento" id="indicio-nombre" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                            <div class="col-md-1 col-sm-1 col-xs-12">
